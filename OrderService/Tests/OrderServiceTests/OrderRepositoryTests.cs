...
namespace OrderServiceTests
{
    ...
    {
        [Fact]
        public async Task Create_When_User_And_Address_Are_Given_Should_Add_Order()
        {
            //Arrange
            ...
            var user = context.Users.Find(1l);
            var address = context.Addresses.Find(1l);
        ...
        private static OrderDetail[] InitializeOrderDependencies(OrderDbContext context)
        {
            ...
            OrderDetail[] orderDetails = new OrderDetail[]{
                new() { OrderDetailId = 1, OrderId = 1, ProductId = 1, Quantity = 3 },
                new() { OrderDetailId = 2, OrderId = 1, ProductId = 2, Quantity = 2 },
                new() { OrderDetailId = 3, OrderId = 2, ProductId = 1, Quantity = 1 }
            };
